	...
	public gameView(Game game, Player p1, Player p2) throws IOException{
		...
		for(int i=4;i>-1;i--){
			for(int j=0;j<5;j++){
				...
				buttons[4-j][4-i].setBounds(250+(4-i)*160,5+(j)*130,160,130);
	...
	public void imageUpdate() {
		...
		for(int i=4;i>-1;i--){
			for(int j=0;j<5;j++){
				...
				buttons[4-j][4-i].setBounds((int) ((250+(4-i)*160)*Game.getScale()),(int) ((5+(j)*130)*Game.getScale()),(int) (160*Game.getScale()),(int) (130*Game.getScale()));
